#ifndef CC1200_MODE_TX_RSSI_H
#define CC1200_MODE_TX_RSSI_H
...
REG_TYPE ExtRegSettings[MAX_EXT_REG] =
{
    ...
    {FS_VCO4         , 0x11 },  // FS Voltage Controlled Oscillator Configuration Reg..
    ...
    {RSSI1           , 0x15 },  // Received Signal Strength Indicator Reg. 1
    {RSSI0           , 0x47 },  // Received Signal Strength Indicator Reg.0
    {MARCSTATE       , 0x6d },  // MARC State
    {LQI_VAL         , 0x1d },  // Link Quality Indicator Value
    {PQT_SYNC_ERR    , 0xf9 },  // Preamble and Sync Word Error
    {DEM_STATUS      , 0x92 },  // Demodulator Status
    {FREQOFF_EST1    , 0x00 },  // Frequency Offset Estimate MSB
    {FREQOFF_EST0    , 0x4a },  // Frequency Offset Estimate LSB
    ...
    {CFM_RX_DATA_OUT , 0x1c },  // Custom Frequency Modulation RX Data
    ...
    {MAGN0           , 0x1e },  // Signal Magnitude after CORDIC [7:0]
    {ANG1            , 0x03 },  // Signal Angular after CORDIC [9:8]
    {ANG0            , 0x35 },  // Signal Angular after CORDIC [7:0]
    {CHFILT_I2       , 0x00 },  // Channel Filter Data Real Part [16]
    {CHFILT_I1       , 0xff },  // Channel Filter Data Real Part [15:8]
    {CHFILT_I0       , 0x00 },  // Channel Filter Data Real Part [7:0]
    {CHFILT_Q2       , 0x01 },  // Channel Filter Data Imaginary Part [16]
    {CHFILT_Q1       , 0x00 },  // Channel Filter Data Imaginary Part [15:8]
    {CHFILT_Q0       , 0xfc },  // Channel Filter Data Imaginary Part [7:0]
    {GPIO_STATUS     , 0x0c },  // General Purpose Input/Output Status
    ...
    {SERIAL_STATUS   , 0x09 },  // Serial Status
