...
REG_TYPE RegSettings[MAX_REG] =
{
    ...
    {AGC_CS_THR     , 0xee }, // Carer Sense Threshold Configuration
...
REG_TYPE ExtRegSettings[MAX_EXT_REG] =
{
    ...
    {FS_CHP          , 0x2c },  // Frequency Synthesizer Charge Pump Configuration
    ...
    {FS_VCO4         , 0x16 },  // FS Voltage Controlled Oscillator Configuration Reg..
    ...
    {RSSI1           , 0x19 },  // Received Signal Strength Indicator Reg. 1
    {RSSI0           , 0x07 },  // Received Signal Strength Indicator Reg.0
    {MARCSTATE       , 0x41 },  // MARC State
    {LQI_VAL         , 0x12 },  // Link Quality Indicator Value
    {PQT_SYNC_ERR    , 0xfa },  // Preamble and Sync Word Error
    {DEM_STATUS      , 0x12 },  // Demodulator Status
    {FREQOFF_EST1    , 0x00 },  // Frequency Offset Estimate MSB
    {FREQOFF_EST0    , 0x8b },  // Frequency Offset Estimate LSB
    ...
    {MAGN0           , 0x14 },  // Signal Magnitude after CORDIC [7:0]
    {ANG1            , 0x02 },  // Signal Angular after CORDIC [9:8]
    {ANG0            , 0xc7 },  // Signal Angular after CORDIC [7:0]
    ...
    {GPIO_STATUS     , 0x09 },  // General Purpose Input/Output Status
